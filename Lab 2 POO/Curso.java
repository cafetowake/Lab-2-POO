...
public class Curso {
    ...
    public Curso(int idCurso2, String nombreCurso2, int horario2, int duracion2, String[] dias2,
            int cantidadEstudiantes2) {
    }
    ...
    public int getIdEdificio() {
        if (sede != null) {
            Edificio edificio = sede.buscarEdificioPorId(getNivel());
            if (edificio != null) {
